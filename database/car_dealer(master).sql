...
(3, 'Administrator', 'admin', 'admin@local', '$2y$10$QLLXIyhlJOvAFabjG/BcYOcs6VmaZirlH7hfCvdC./2bvZ6MGOWLK', '2026-03-09 10:17:23'),
(4, 'Second Admin', 'admin', 'admin2@local', '$2y$10$CjAQbwzB8DYo/BT53jWRBu42T9441Vd0IXIq39WZev2.pdCekGuJq', '2026-03-09 10:17:23');
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `fk_reservations_vehicle` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `viewing_schedules`
--
ALTER TABLE `viewing_schedules`
  ADD CONSTRAINT `fk_viewing_customer` FOREIGN KEY (`customer_id`) REFERENCES `customers` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fk_viewing_vehicle` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicles` (`id`) ON DELETE CASCADE;
COMMIT;
